...
[![npm](https://img.shields.io/npm/v/@hishprorg/velit-maxime.svg)](https://www.npmjs.com/package/@hishprorg/velit-maxime)
...
```ts
import type * as CSS from '@hishprorg/velit-maxime';
...
```js
// @flow strict
import * as CSS from '@hishprorg/velit-maxime';
...
```sh
$ npm install @hishprorg/velit-maxime
```
...
2.  **Have a look in [issues](https://github.com/hishprorg/velit-maxime/issues) to see if an issue already has been filed. If not, create a new one.** To help us out, please refer to any information you have found.
3.  Fix the issue locally with **TypeScript** (Flow further down):
    ...
    - The recommended way is to use **module augmentation**. Here's a few examples:
      ...
      declare module '@hishprorg/velit-maxime' {
